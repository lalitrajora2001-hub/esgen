...
const REGS: Reg[] = [
  ...
  { name: "IFRS S1 / S2 (ISSB)", juris: "Global", who: "Companies in jurisdictions adopting the ISSB baseline.", what: "Global baseline sustainability and climate disclosure standards from the IFRS Foundation. S2 fully incorporates the TCFD recommendations.", href: "/platform/tcfd-ifrs" },
  ...
  { name: "EUDR", juris: "EU", who: "Operators and traders placing certain commodities on the EU market.", what: "The EU Deforestation Regulation, requiring geolocated, deforestation-free supply chains for commodities such as cocoa, coffee, soya, and wood.", href: "/platform/eudr" },
  ...
  { name: "VSME", juris: "EU", who: "Small and medium-sized undertakings not in CSRD scope.", what: "A voluntary EFRAG standard giving SMEs a proportionate way to answer the sustainability questions their customers and banks ask.", href: "/platform/vsme" },
];
